...
func epMain(name string) {
	...
	handler := func() {
		cfg, err := Fetch(clientset, clientSetK, name, gvr2, gvr3)
		if err != nil {
...
func Fetch(clientset dynamic.Interface, clientSetK kubernetes.Interface, name string, gvr2, gvr3 schema.GroupVersionResource) (*Config, error) {
