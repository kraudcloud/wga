...
| `web.authentikId`                    | Authentik ID for the web component                                                                                               | `""`           |
| `web.authentikDomain`                | Authentik domain for the web component                                                                                           | `""`           |
| `web.authentikSecret`                | Authentik secret for the web component                                                                                           | `""`           |
| `web.debug`                          | Debug mode for the web component                                                                                                 | `*`            |
