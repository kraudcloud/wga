...
type Interface interface {
	...
	WireguardClusterClient() WireguardClusterClientController
}
...
func (c *version) WireguardClusterClient() WireguardClusterClientController {
	return NewWireguardClusterClientController(schema.GroupVersionKind{Group: "wga.kraudcloud.com", Version: "v1beta", Kind: "WireguardClusterClient"}, "wireguardclusterclients", false, c.controllerFactory)
}
